...
Synthetic/mock data only. No production data, no real patient records.`},
        ...
        {type:'code',title:{th:'สร้าง template เก็บไว้ใช้งาน',en:'Create a template for reuse'},
