...
The mock must reproduce special states on demand: normal / slow (~2s delay to make Loading visible) / empty / error — demonstrated through Storybook only, with no scenario switcher on the user-facing page.`},
        ...
        {type:'code',title:{th:'แบบฟอร์ม Issue สำหรับงานถัดไป',en:'Issue form for later work'},
          lead:{th:'ใช้แบบฟอร์มนี้เป็นตัวอย่างตอนเขียน Issue จริง หากทีมต้องการใช้ซ้ำ ค่อยเก็บเป็น template ในงานที่ได้รับอนุมัติ',en:'Use this form as an example for the real issue. If your team wants to reuse it, save it as a template in an approved follow-up task.'},
...
Keep it short and never include anything that was not actually done.`},
        ...
        {type:'code',title:{th:'แบบฟอร์ม MR สำหรับใช้ซ้ำ',en:'Reusable MR form'},
          lead:{th:'ใช้แบบฟอร์มเปล่านี้เป็นตัวอย่างร่าง MR รอบปัจจุบัน หากทีมต้องการใช้ซ้ำ ค่อยเก็บเป็น template ในงานที่ได้รับอนุมัติ',en:'Use this blank form for the current MR. If your team wants to reuse it, save it as a template in an approved follow-up task.'},
...
If evidence is missing, say no evidence yet. Never guess.`},after:{th:['เปิดหลักฐานทุกชิ้นตามที่ร่างไว้','ให้ Developer ลองเปิดงานโดยไม่อธิบายปากเปล่า'],en:['Open every cited piece of evidence','Let a developer run the work without verbal help']}},
        {type:'callout',title:{th:'ทำซ้ำด้วย Agent Skill ได้ภายหลัง',en:'An agent skill can repeat this later'},text:{th:'หลังทำ handoff ด้วยมือหนึ่งครั้ง จึงค่อยเก็บแบบฟอร์มเป็น template หรือ SKILL.md สำหรับรวบรวมหลักฐานซ้ำ คำอธิบาย skill ต้องสั้นและบอกว่าใช้เมื่อไร ตรวจว่า Agent ที่ใช้โหลด skill จาก path ใดจริง อย่าสมมติว่าทุกเครื่องมืออ่าน .agents/skills อัตโนมัติ Skill ช่วยร่าง; คนอนุมัติก่อนส่งออกนอกเครื่อง',en:'After one handoff by hand, save the form as a template or SKILL.md for repeated evidence gathering. Give the skill a short description saying when it applies. Verify the skill path your agent actually supports; do not assume every tool auto-loads .agents/skills. A skill drafts; a human approves before sending anything off the machine.'}},
