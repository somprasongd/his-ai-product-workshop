...
Synthetic/mock data only. No production data, no real patient records.`},
        ...
        {type:'two',title:{th:'เปิด Issue จริงบน GitHub หรือ GitLab',en:'File the real issue on GitHub or GitLab'},left:{title:{th:'บน GitHub',en:'On GitHub'},items:{th:['เปิด repository ของคุณ (fork จากบทที่ 00) แล้วไปที่แท็บ **Issues**','กด **New issue** แล้ววาง Title จาก template ลงช่อง title','วางเนื้อ template ฉบับที่แก้แล้วลงช่อง description — Markdown ใช้ได้ทุกรูปแบบ','กด **Submit new issue** แล้วจดเลข Issue ที่ขึ้นมา เช่น `#12`'],en:['Open your repository (the fork from lesson 00) and go to the **Issues** tab','Click **New issue** and paste the template title into the title field','Paste your revised template body into the description — full Markdown works','Click **Submit new issue**, then note the issue number, e.g. `#12`']},example:{th:'**ผลลัพธ์ที่ต้องได้:** ลิงก์แบบ `github.com/<ชื่อคุณ>/<repo>/issues/12` และเลข `12` ถูกจดไว้ — บทที่ 05 จะให้ Agent อ่าน Issue นี้ด้วย `gh issue view 12`',en:'**What you end up with:** a link like `github.com/<you>/<repo>/issues/12` with the number `12` written down — lesson 05 has the agent read this issue with `gh issue view 12`.'}},right:{title:{th:'บน GitLab',en:'On GitLab'},items:{th:['เปิด project ของคุณ (จากบทที่ 00) แล้วไปที่เมนู **Plan → Issues**','กด **New issue** แล้ววาง Title จาก template ลงช่อง Title','วางเนื้อ template ฉบับที่แก้แล้วลงช่อง Description','กด **Create issue** แล้วจดเลข Issue ที่ขึ้นมา เช่น `#12`'],en:['Open your project (from lesson 00) and go to **Plan → Issues**','Click **New issue** and paste the template title into the Title field','Paste your revised template body into the Description field','Click **Create issue**, then note the issue number, e.g. `#12`']},example:{th:'**ผลลัพธ์ที่ต้องได้:** ลิงก์แบบ `gitlab.com/<ชื่อคุณ>/<repo>/-/issues/12` และเลข `12` ถูกจดไว้ — บทที่ 05 จะให้ Agent อ่าน Issue นี้ด้วย `glab issue view 12`',en:'**What you end up with:** a link like `gitlab.com/<you>/<repo>/-/issues/12` with the number `12` written down — lesson 05 has the agent read this issue with `glab issue view 12`.'}}},
